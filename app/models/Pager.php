                ...
                <nav class="<?=$this->nav_class?>" style="<?=$this->nav_styles?>">
                    <ul class="<?=$this->ul_class?>" style="<?=$this->ul_styles?>">
                        ...
                        <?php for($x = $this->start; $x <= $this->end;$x++):?>
                            ...
                            "><a class="<?=$this->a_class?>" style="<?=$this->a_styles?>" href="
                            <?= preg_replace('/page=[0-9]+/', "page=".$x, $this->links['current'])?>
                            "><?=$x?></a></li>
                        <?php endfor;?>

                        <li class="<?=$this->next_li_class?>" style="<?=$this->next_li_styles?>"><a class="<?=$this->next_a_class?>" style="<?=$this->next_a_styles?>" href="<?=$this->links['next']?>">Next</a></li>
                    </ul>
                </nav>
            </div>
            <?php
